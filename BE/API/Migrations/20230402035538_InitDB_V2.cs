        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    RatingAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Trái Đất", "intro_to_mobile_root@gmail.com", 10.0, "Root", "1000:tT4uzWmXrdQSz03hsmFtuGi6OiLRbyVw:+wkkFv4MRvSLU4b4nd3LsgtX26c=", "0905473034", 0 },
                    { 2, "Trái Đất", "hieucckha@gmail.com", 10.0, "Hiếu Nguyễn", "1000:9Xm7xPF4uz/okW6dU821r6AdeNxi2yfc:lq5GWzEHCLaF4DqBaz0gS2QLK/s=", "0905473034", 0 }
                });
