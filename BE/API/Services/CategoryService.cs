...
public class CategoryService : ICategoryService
{
    ...
    public async Task<IEnumerable<CategoryRes>> Get()
    {
        ...
        return _mapper.Map<IEnumerable<Api.Context.Entities.Category>, IEnumerable<CategoryRes>>(categories);
    }
    ...
    public async Task<CategoryRes> Get(int id)
    {
        ...
        return _mapper.Map<Api.Context.Entities.Category, CategoryRes>(category);
    }
    ...
    public async Task<bool> Create(CreateCategoryReq request)
    {
        try
        {
            var category = _mapper.Map<CreateCategoryReq, Api.Context.Entities.Category>(request);
